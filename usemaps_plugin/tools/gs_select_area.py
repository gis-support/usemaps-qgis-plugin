...
class GsSelectArea(QWidget, FORM_CLASS):
    ...
    def closeWidget(self) -> None:
        if self.tool:
            ...
            if current_tool in (self.select_features_tool, self.select_features_rectangle_tool, self.select_features_freehand_tool):
                iface.mapCanvas().unsetMapTool(current_tool)
